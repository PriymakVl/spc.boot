<?php 
	...
	$this->registerJsFile('@web/js/product/select/podgotovka_vozdukha/filtry.js', ['depends' => 'yii\web\YiiAsset']);
	...
	<div class="product__series">
		...
		<div class="select-wrp">
			...
			<select name="series" id="product_series">
				...
				<option value="SA-FN">SA-FN</option>
				<option value="SA-FU">SA-FU</option>
				<option value="SA-FM">SA-FM</option>
				<option value="SA-FH">SA-FH</option>
			</select>
		</div>
	</div>
	<!-- Thread -->
