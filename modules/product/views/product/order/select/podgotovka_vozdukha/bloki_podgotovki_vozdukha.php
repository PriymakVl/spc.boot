<?php 
	...
	$this->registerJsFile('@web/js/product/select/podgotovka_vozdukha/bloki_podgotovki_vozdukha.js', ['depends' => 'yii\web\YiiAsset']);
	...
	<div class="product__series">
		...
		<div class="select-wrp">
			...
			<select name="series" id="product_series">
				...
				<option value="SA-CN">SA-CN</option>
				<option value="SA-CU">SA-CU</option>
				<option value="SA-CM">SA-CM</option>
			</select>
		</div>
	</div>
	<!-- Thread -->
